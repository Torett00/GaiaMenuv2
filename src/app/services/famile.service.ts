...
export class FamileService {
  ...
  private selectedfamilename: string = "";
  ...
  // navigation to menu 
  setfamilename(name: string) {
    this.selectedfamilename = name;
  }

  getfamilename(): string | "" {
    return this.selectedfamilename;
  }

  clearfamilename() {
    this.selectedfamilename = "";
  }
}
