...
export class DetalisComponent {
  ...
  Famille = [
    {
      famillename: "Nos Plats",
      Categories: [
        {
          categoriename: "Freshness",
          Products: [
            {
              productName: "La salade César By Gaia",
              descriptionProduct: "Avec tomates cerises, olives et feta",
              priceproduct: "25.00 TND"
            },
            {
              productName: "Salade Méditerranéenne",
              descriptionProduct: "Avec tomates cerises, olives et feta",
              priceproduct: "22.00 TND"
            }
          ]
        },
        {
          categoriename: "Gourmandise",
          Products: [
            {
              productName: "Cheeseburger maison",
              descriptionProduct: "Avec steak pur bœuf et cheddar",
              priceproduct: "28.00 TND"
            }
          ]
        },
        {
